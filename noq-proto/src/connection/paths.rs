...
pub(super) struct PathData {
    ...
    /// Whether this path needs to report its remote address back to the peer. This only happens if
    /// both peers agree to do so based on their transport parameters.
